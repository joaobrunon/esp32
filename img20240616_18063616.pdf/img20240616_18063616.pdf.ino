...
const char* ssid = "joao bruno"; /* coloque aqui o nome da rede wi-fi que o ESP32 deve se conectar */
const char* password = "bruno1234"; /* coloque aqui a senha da rede wi-fi que o ESP32 deve se conectar */
